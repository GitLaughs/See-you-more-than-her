...
### ✅ Issue 1: Aurora 伴侣工具开发
**标题**: `[Feature] Aurora 伴侣工具 - 实时数据可视化与固件烧录`
**状态**: ✅ 已完成
**标签**: `enhancement`, `visualization`, `tools`

**描述**:
开发 Aurora 伴侣工具，提供以下功能：
...
**成果**: `src/a1_ssne_ai_demo/src/yolov8_detector.cpp`
...
**成果**: `src/a1_ssne_ai_demo/src/lidar_sdk_adapter.cpp`
...
**关联模块**: `src/a1_ssne_ai_demo/demo_vision.cpp`
