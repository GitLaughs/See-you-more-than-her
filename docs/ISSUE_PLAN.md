...
| 成员 | 职责领域 | 关联模块 |
|---|---|---|
| 成员 A（视觉/AI） | YOLOv8 训练、手势识别、相机驱动 | `ssne_vision_demo`、`ncnn_ros2`、模型训练 |
...
- [ ] RPLidar 串口稳定发布 `/scan`
- [ ] `ssne_vision_demo` 在板端运行，YOLOv8 检测正常
- [ ] 人脸检测与 OSD 多层叠加正常显示
...
| [docs/BUILD.md](BUILD.md) | 编译手册 |
| [docs/CONTAINER_OPERATION_GUIDE.md](CONTAINER_OPERATION_GUIDE.md) | Docker 容器操作 |
| [docs/YOLOV8_TRAINING.md](YOLOV8_TRAINING.md) | YOLOv8 训练与部署 |
| [docs/RPLIDAR_SDK_GUIDE.md](RPLIDAR_SDK_GUIDE.md) | RPLidar 接入指南 |
| [src/a1_ssne_ai_demo/README.md](../src/a1_ssne_ai_demo/README.md) | SSNE Demo 模块说明 |
